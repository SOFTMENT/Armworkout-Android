...
import in.softment.armworkout.ProfileSetup.MoreRelaxedActivity;
...
// OnScrollListener
        ...
        findViewById(R.id.updateBtn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ProgressHud.show(EditHeightActivity.this,"Updating...");
                Map<String, String> map = new HashMap<>();
                map.put("height", UserModel.data.getHeight());
                FirebaseFirestore.getInstance().collection("Users").document(FirebaseAuth.getInstance().getCurrentUser().getUid()).set(map, SetOptions.merge()).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if (task.isSuccessful()) {
                            Services.showCenterToast(EditHeightActivity.this, "Updated");
                        }
                    }
                });
