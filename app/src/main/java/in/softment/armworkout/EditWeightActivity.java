...
import in.softment.armworkout.ProfileSetup.AgeActivity;
...
// OnScrollListener
        ...
        findViewById(R.id.updateBtn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ProgressHud.show(EditWeightActivity.this,"Updating...");
                Map<String, String> map = new HashMap<>();
                map.put("weight", UserModel.data.getWeight());
                FirebaseFirestore.getInstance().collection("Users").document(FirebaseAuth.getInstance().getCurrentUser().getUid()).set(map, SetOptions.merge()).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if (task.isSuccessful()) {
                            Services.showCenterToast(EditWeightActivity.this, "Updated");
                        }
                    }
                });
            }
