...
public class EditGenderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (UserModel.data.getGender().equalsIgnoreCase("Male")) {
        ...
        else if (UserModel.data.gender.equalsIgnoreCase("Female")) {
        ...
        findViewById(R.id.updateBtn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ProgressHud.show(EditGenderActivity.this,"Updating...");
                Map<String, String> map = new HashMap<>();
                map.put("gender", UserModel.data.getGender());
                FirebaseFirestore.getInstance().collection("Users").document(FirebaseAuth.getInstance().getCurrentUser().getUid()).set(map, SetOptions.merge()).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if (task.isSuccessful()) {
                            Services.showCenterToast(EditGenderActivity.this, "Updated");
                        }
                    }
                });
            }
